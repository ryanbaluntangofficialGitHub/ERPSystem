...
namespace ERPSystem.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CanvassingItems",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CanvassingId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CanvassingItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CanvassingItems_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CanvassingItems_Suppliers_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CompanyId = table.Column<int>(type: "int", nullable: false),
                    CanvassingNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    PurchaseRequestId = table.Column<int>(type: "int", nullable: true),
                    CanvassingDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Canvassings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Canvassings_Suppliers_SelectedSupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchaseRequestId = table.Column<int>(type: "int", nullable: true),
                    CanvassingId = table.Column<int>(type: "int", nullable: true),
                    SupplierId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseOrders_Canvassings_CanvassingId",
                        column: x => x.CanvassingId,
                        principalTable: "Canvassings",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CanvassingItems_CanvassingId",
                table: "CanvassingItems",
                column: "CanvassingId");

            migrationBuilder.CreateIndex(
                name: "IX_CanvassingItems_ProductId",
                table: "CanvassingItems",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_CanvassingItems_SupplierId",
                table: "CanvassingItems",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_Canvassings_PurchaseRequestId",
                table: "Canvassings",
                column: "PurchaseRequestId");

            migrationBuilder.CreateIndex(
                name: "IX_Canvassings_SelectedSupplierId",
                table: "Canvassings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseOrders_CanvassingId",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_CanvassingItems_Canvassings_CanvassingId",
                table: "CanvassingItems",
                column: "CanvassingId",
                principalTable: "Canvassings",
                principalColumn: "Id",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Canvassings_PurchaseRequests_PurchaseRequestId",
                table: "Canvassings",
                column: "PurchaseRequestId",
                principalTable: "PurchaseRequests",
                principalColumn: "Id");
