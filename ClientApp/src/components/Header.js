...
export default function Header({ onLogout }) {
    ...
    return (
        <header className="w-full bg-white border-b p-3 flex items-center justify-end gap-4">
            <div className="flex items-center gap-3">
                ...
                <div className="relative" ref={ref}>
                    ...
                    >
                        <div className="w-8 h-8 bg-blue-500 rounded-full text-white flex items-center justify-center font-semibold">{initials}</div>
